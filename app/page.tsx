...
export default async function Index() {
  return (
    <>
      ...
      <div className="flex w-full flex-1 flex-col  flex-wrap items-center justify-center sm:flex-row">
        <div className="flex w-1/4 flex-row justify-center">
          <Image
            ...
            height="0"
            sizes="100vw"
            className="h-[250px] w-[150px] sm:h-[500px] sm:w-[300px]"
          />
        </div>
        <div className="flex max-w-[650px] flex-col justify-center px-10 text-center leading-[3rem] sm:justify-start sm:gap-5 sm:px-0 sm:text-left">
          <h1>
      ...
      <footer className="bg-gray mt-auto hidden min-h-24 w-full flex-row items-center justify-center gap-20 border-t sm:flex">
        <span className="border-purple border-l-[6px] pl-4 text-[23px] leading-6">
          Contact us!
        </span>
        ...
        <div className="text-graysubtitle flex w-[200px] gap-2 text-xs leading-3">
          <div>
            <svg
