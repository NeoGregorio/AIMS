    ...
    return (
      <>
        <NavBar
          ...
          currentActive={""}
        />
        <div className="flex w-full flex-1 flex-col flex-wrap items-center justify-center gap-6 py-10 sm:flex-row sm:gap-0">
          ...
          <div className="flex max-w-[650px] flex-col justify-center gap-2 px-10 text-center sm:justify-start sm:gap-5 sm:px-0 sm:text-left">
            <h1>
        ...
        <footer className="bg-gray flex min-h-24 w-full flex-row items-center justify-center gap-0 border-t sm:gap-20">
          <div className="flex flex-col gap-4 p-6 pr-0 sm:flex-row sm:gap-8">
            <span className="border-purple border-l-[6px] pl-4 text-[23px]">
              Contact us!
            </span>
